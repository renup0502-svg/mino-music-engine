...
ALBUM_NAME = "Rain Valley - Autumn Stories"
...
def build_command() -> None:
    ...
    chapters_path = reports_folder / "chapters.txt"
    ...
    print(f"Chapters generated: {len(chapter_lines)}")
    print(f"Chapter file: {chapters_path}")

    raw_output = (
        project_root
        / "exports"
        / "Rain Valley - Autumn Stories - 2 Hours (Raw).mp3"
    )
    ...
    try:
        embed_metadata(
            ...
            title=ALBUM_NAME,
            artist="Study With Mino",
            album="Rain Valley",
            genre="Lo-Fi",
            year="2026",
            comment="Generated by the Mino Music Engine",
        )
    ...
    print()
    print("Production reports created.")
